...
| **Phase 3 — US1 (Home)** | T016–T023 | Tests backend (T016–T017), test frontend (T018); impl backend GET /products (T019), frontend hook (T020), página Home (T021–T023) | senior-backend (T016–T019), senior-frontend (T018, T020–T023); senior-ux-designer para specs de diseño home (layout, cards, grid) si se pide alineación Meli. |
| **Phase 4 — US2 (Detalle)** | T024–T031 | Tests backend (T024–T025), test frontend (T026); impl backend GET /products/:id (T027), frontend hook (T028), página ProductDetail (T029–T031) | senior-backend (T024–T027), senior-frontend (T026, T028–T031); senior-ux-designer para specs de diseño detalle (galería, bloque compra, vendedor) si se pide alineación Meli. |
